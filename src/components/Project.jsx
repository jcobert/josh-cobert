  ...
  return (
    <div>
      <div className="page-wrapper">
        ...
        <div className="grid grid-cols-1 gap-y-6 md:grid-cols-2 lg:grid-cols-5 mt-8 md:mt-12">
          {/* Heading */}
          ...
          <div className="lg:col-start-3 lg:col-span-3 w-full lg:w-11/12 mx-auto">
            {/* Preview Image */}
            <div
              className="h-36 md:h-full bg-cover border shadow-sm"
              style={{ backgroundImage: `url(${state.img})` }}
            ></div>
          </div>
        </div>
        <div className="mt-24 lg:grid grid-cols-5">
          {/* Technologies */}
          ...
          {/* Description */}
          <div className="lg:col-start-3 col-span-3 lg:w-11/12 m-auto px-8 md:px-8">
            <p className="text-md sm:text-lg lg:px-2">
